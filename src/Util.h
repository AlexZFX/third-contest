...
void initTableMap(unordered_map<string, Table *> &tableMap) {
  // warehouse
  {
    ...
    Column w1{"w_id", 1, MYSQL_TYPE_LONG, 10, 10, 10};
    Column w2{"w_name", 2, MYSQL_TYPE_VARCHAR, 10, 10, 10};
    Column w3{"w_street_1", 3, MYSQL_TYPE_VARCHAR, 20, 10, 10};
    Column w4{"w_street_2", 4, MYSQL_TYPE_VARCHAR, 20, 10, 10};
    Column w5{"w_city", 5, MYSQL_TYPE_VARCHAR, 20, 10, 10};
    Column w6{"w_state", 6, MYSQL_TYPE_VARCHAR, 2, 10, 10};
    Column w7{"w_zip", 7, MYSQL_TYPE_VARCHAR, 9, 10, 10};
    Column w8{"w_tax", 8, MYSQL_TYPE_DECIMAL, 4, 2, 10};
    Column w9{"w_ytd", 9, MYSQL_TYPE_DECIMAL, 12, 2, 10};
  ...
  // district
  {
    ...
    Column d1{"d_id", 1, MYSQL_TYPE_LONG, 10, 10, 10};
    Column d2{"d_w_id", 2, MYSQL_TYPE_LONG, 10, 10, 10};
    Column d3{"d_name", 3, MYSQL_TYPE_VARCHAR, 10, 10, 10};
    Column d4{"d_street_1", 4, MYSQL_TYPE_VARCHAR, 20, 10, 10};
    Column d5{"d_street_2", 5, MYSQL_TYPE_VARCHAR, 20, 10, 10};
    Column d6{"d_city", 6, MYSQL_TYPE_VARCHAR, 20, 10, 10};
    Column d7{"d_state", 7, MYSQL_TYPE_VARCHAR, 2, 10, 10};
    Column d8{"d_zip", 8, MYSQL_TYPE_VARCHAR, 9, 10, 10};
    Column d9{"d_tax", 9, MYSQL_TYPE_DECIMAL, 4, 2, 10};
    Column d10{"d_ytd", 10, MYSQL_TYPE_DECIMAL, 12, 2, 10};
    Column d11{"d_next_o_id", 11, MYSQL_TYPE_LONG, 12, 2, 10};
  ...
  // customer
  {
    ...
    Column c1{"c_id", 1, MYSQL_TYPE_LONG, 10, 10, 10};
    Column c2{"c_d_id", 2, MYSQL_TYPE_LONG, 10, 10, 10};
    Column c3{"c_w_id", 3, MYSQL_TYPE_LONG, 10, 10, 10};
    Column c4{"c_first", 4, MYSQL_TYPE_VARCHAR, 16, 10, 10};
    Column c5{"c_middle", 5, MYSQL_TYPE_VARCHAR, 2, 10, 10};
    Column c6{"c_last", 6, MYSQL_TYPE_VARCHAR, 16, 10, 10};
    Column c7{"c_street_1", 7, MYSQL_TYPE_VARCHAR, 20, 10, 10};
    Column c8{"c_street_2", 8, MYSQL_TYPE_VARCHAR, 20, 10, 10};
    Column c9{"c_city", 9, MYSQL_TYPE_VARCHAR, 20, 10, 10};
    Column c10{"c_state", 10, MYSQL_TYPE_VARCHAR, 2, 10, 10};
    Column c11{"c_zip", 11, MYSQL_TYPE_VARCHAR, 9, 10, 10};
    Column c12{"c_phone", 12, MYSQL_TYPE_VARCHAR, 16, 10, 10};
    Column c13{"c_since", 13, MYSQL_TYPE_DATETIME, 4, 2, 10};
    Column c14{"c_credit", 14, MYSQL_TYPE_VARCHAR, 2, 10, 10};
    Column c15{"c_credit_lim", 15, MYSQL_TYPE_LONG, 10, 10, 10};
    Column c16{"c_discount", 16, MYSQL_TYPE_DECIMAL, 4, 2, 10};
    Column c17{"c_balance", 17, MYSQL_TYPE_DECIMAL, 12, 2, 10};
    Column c18{"c_ytd_payment", 18, MYSQL_TYPE_DECIMAL, 12, 2, 10};
    Column c19{"c_payment_cnt", 19, MYSQL_TYPE_LONG, 12, 2, 10};
    Column c20{"c_delivery_cnt", 20, MYSQL_TYPE_LONG, 12, 2, 10};
    Column c21{"c_data", 21, MYSQL_TYPE_VAR_STRING, 12, 2, 10};
  ...
  // new_orders
  {
    ...
    Column w1{"no_o_id", 1, MYSQL_TYPE_LONG, 10, 10, 10};
    Column w2{"no_d_id", 2, MYSQL_TYPE_LONG, 10, 10, 10};
  ...
  // orders
  {
    ...
    Column w1{"o_id", 1, MYSQL_TYPE_LONG, 10, 10, 10};
    Column w2{"no_d_id", 2, MYSQL_TYPE_LONG, 10, 10, 10};
    Column w3{"no_w_id", 3, MYSQL_TYPE_LONG, 20, 10, 10};
    Column w4{"o_c_id", 4, MYSQL_TYPE_LONG, 20, 10, 10};
    Column w5{"o_entry_d", 5, MYSQL_TYPE_DATETIME, 20, 10, 10};
    Column w6{"o_carrier_id", 6, MYSQL_TYPE_LONG, 2, 10, 10};
    Column w7{"o_ol_cnt", 7, MYSQL_TYPE_LONG, 9, 10, 10};
    Column w8{"o_all_local", 8, MYSQL_TYPE_LONG, 4, 2, 10};
    orders->addColumn(w1);
    orders->addColumn(w2);
    orders->addColumn(w3);
    orders->addColumn(w4);
  ...
  // order_line
  {
    ...
    Column w1{"ol_o_id", 1, MYSQL_TYPE_LONG, 10, 10, 10};
    Column w2{"ol_d_id", 2, MYSQL_TYPE_LONG, 10, 10, 10};
    Column w3{"ol_w_id", 3, MYSQL_TYPE_LONG, 20, 10, 10};
    Column w4{"ol_number", 4, MYSQL_TYPE_LONG, 20, 10, 10};
    Column w5{"ol_i_id", 5, MYSQL_TYPE_LONG, 20, 10, 10};
    Column w6{"ol_supply_w_id", 6, MYSQL_TYPE_LONG, 2, 10, 10};
    Column w7{"ol_delivery_d", 7, MYSQL_TYPE_DATETIME, 9, 10, 10};
    Column w8{"ol_quantity", 8, MYSQL_TYPE_LONG, 4, 2, 10};
    Column w9{"ol_amount", 9, MYSQL_TYPE_DECIMAL, 6, 2, 10};
    Column w10{"ol_dist_info", 10, MYSQL_TYPE_VARCHAR, 24, 2, 10};
  ...
  // item
  {
    ...
    Column w1{"i_id", 1, MYSQL_TYPE_LONG, 10, 10, 10};
    Column w2{"i_im_id", 2, MYSQL_TYPE_LONG, 10, 10, 10};
    Column w3{"i_name", 3, MYSQL_TYPE_VARCHAR, 24, 10, 10};
    Column w4{"i_price", 4, MYSQL_TYPE_DECIMAL, 5, 2, 10};
    Column w5{"i_data", 5, MYSQL_TYPE_VARCHAR, 50, 10, 10};
    item->addColumn(w1);
    item->addColumn(w2);
    item->addColumn(w3);
    item->addColumn(w4);
  ...
  // stock
  {
    ...
    Column w1{"s_i_id", 1, MYSQL_TYPE_LONG, 10, 10, 10};
    Column w2{"s_w_id", 2, MYSQL_TYPE_LONG, 10, 10, 10};
    Column w3{"s_quantity", 3, MYSQL_TYPE_LONG, 20, 10, 10};
    Column w4{"s_dist_01", 4, MYSQL_TYPE_VARCHAR, 24, 10, 10};
    Column w5{"s_dist_02", 5, MYSQL_TYPE_VARCHAR, 24, 10, 10};
    Column w6{"s_dist_03", 6, MYSQL_TYPE_VARCHAR, 24, 10, 10};
    Column w7{"s_dist_04", 7, MYSQL_TYPE_VARCHAR, 24, 10, 10};
    Column w8{"s_dist_05", 8, MYSQL_TYPE_VARCHAR, 24, 2, 10};
    Column w9{"s_dist_06", 9, MYSQL_TYPE_VARCHAR, 24, 2, 10};
    Column w10{"s_dist_07", 10, MYSQL_TYPE_VARCHAR, 24, 2, 10};
    Column w11{"s_dist_08", 11, MYSQL_TYPE_VARCHAR, 24, 2, 10};
    Column w12{"s_dist_09", 12, MYSQL_TYPE_VARCHAR, 24, 2, 10};
    Column w13{"s_dist_10", 13, MYSQL_TYPE_VARCHAR, 24, 2, 10};
    Column w14{"s_ytd", 14, MYSQL_TYPE_DECIMAL, 8, 0, 10};
    Column w15{"s_order_cnt", 15, MYSQL_TYPE_LONG, 24, 2, 10};
    Column w16{"s_remote_cnt", 16, MYSQL_TYPE_LONG, 24, 2, 10};
    Column w17{"s_data", 17, MYSQL_TYPE_VARCHAR, 50, 2, 10};
    stock->addColumn(w1);
    stock->addColumn(w2);
    stock->addColumn(w3);
    stock->addColumn(w4);
